...
// Copyright (c) 2011-2024 The Litedoge Core developers
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success) {
        ...
        // litedoge: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    // litedoge: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
